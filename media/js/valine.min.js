		...
		o.prototype.Q = function (e) {
			...
			var C = function (t, n, r) {
					...
					var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
						...
						u = T.hide ? "" : e.config.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (T.cdn + (0, s.default)(t.get("mail")) + T.params) + '">' && mailgetAvatar?'<img class="vimg" src="'+(qq_img)+'">':'<img class="vimg" src="' + (T.cdn + (0, s.default)(t.get("mail")) + T.params) + '">',
